  ...
  return(
    <div className='list-rows-item grid-row padding-top-micro padding-bottom-micro align-items-center'>
      ...
      <div className='grid-item flex-grow grid-row no-gutter justify-end'>
        ...
        <div className='grid-item'>
          <button type='button' className='u-pointer font-bold' onClick={() => toastr.confirm('¿Seguro que deseas eliminar este artista?', ToastrOptionsConfirm(removeArtista, key))}>Eliminar</button>
        </div>
      </div>
    </div>
  );
